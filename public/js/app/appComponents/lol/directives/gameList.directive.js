define(
    ...
    function(angular, lolModule) {
        console.info("[INFO] game list directive [require] loaded.");
        ...
        function GameListDirective(gameDataService, championDataService) {
            ...
            return {
                ...
                templateUrl : './js/app/appComponents/lol/views/gameList.tmpl.html',
                scope: {
                    activedSummoner: "="
                }
            };
        }
        return lolModule.directive('gameListDirective', GameListDirective);
    }
);
